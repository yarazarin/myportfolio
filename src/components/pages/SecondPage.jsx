    ...
    <div className="second_container">
      <div className="part_one">
        ...
        <p>
          ...
          crafting user-friendly, efficient web applications and websites that
          drive business success. I bring a keen eye for design, adhering to
          best practices like SEO, security, and responsive design, and I
          leverage JQuery, SCSS and Bootstrap for enhanced styling. With strong
          organizational and problem-solving skills, I'm ready to collaborate
          and contribute to exceptional web solutions. I'm eager to learn more
      ...
      <div className="part_two">
        ...
        <p>
          Check out the code on GitHub and get in touch to discuss collaboration
          or if you have any questions. Thanks for visiting!
        </p>
      </div>
    </div>
  );
